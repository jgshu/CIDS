...
import importlib
import sys
import bigan.unsw_utilities as network
import data.unsw as data
import data.unsw_half as data1
...
def create_logdir(method, weight, rd):
    ...
    return "bigan/train_logs/unsw/{}/{}/{}".format(weight, method, rd)
    ...
    with sv.managed_session() as sess:
        ...
        while not sv.should_stop() and epoch < nb_epochs:
            ...
            for t in range(nr_batches_train):
                ...
                # print("data", i, trainx[ran_from:ran_to])
