...
def test(nb_epochs, weight, method, degree, random_seed):
    ...
    with tf.Session() as sess:
        ...
        saver1.restore(sess, 'model/model_1_30.ckpt')
        print(1)
        saver2.restore(sess, 'model/model_1_30.ckpt')
        print(2)
        saver3.restore(sess, 'model/model_1_30.ckpt')
...
def train_and_test(nb_epochs, weight, method, degree, random_seed):
    ...
    # Data
    trainx1, trainy1 = data.get_train(1)
